...
#> Error : thematic doesn't (yet) support the 'agg_record_3c055b3a4969' graphics device. Please report this error to https://github.com/rstudio/thematic/issues/new
