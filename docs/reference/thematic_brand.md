...
#> Error : thematic doesn't (yet) support the 'agg_record_da9c91c984d' graphics device. Please report this error to https://github.com/rstudio/thematic/issues/new
