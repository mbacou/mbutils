...
#> Error : thematic doesn't (yet) support the 'agg_record_f2621bc7edb2' graphics device. Please report this error to https://github.com/rstudio/thematic/issues/new
