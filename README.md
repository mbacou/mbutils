...
In particular this package includes **Bootstrap** themes and color scales for **base R graphics**, **lattice** and **ggplot**, implementing the (recent) [brand.yml](https://posit-dev.github.io/brand-yml/) flexible document branding system.
...
![Sample branded plot](./man/figures/example.png){width="100%"}

## License

This package is licensed under the terms of the [GNU General Public License](https://www.gnu.org/licenses/gpl-3.0.html) version 3 or later.
